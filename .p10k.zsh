...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local  untracked='%9F'   # blue foreground
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='${P9K_IP_RX_RATE:+%2F⇣$P9K_IP_RX_RATE }${P9K_IP_TX_RATE:+%9F⇡$P9K_IP_TX_RATE }%0F$P9K_IP_IP'
